define("UsrReality_ListPage", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
			...
			},
			{
				...
				"values": {
					"columns": [
						...
						{
							"id": "1aedf19c-f344-2665-5997-d20f0f6a30c7",
							"code": "PDS_UsrType",
							"caption": "#ResourceString(PDS_UsrType)#",
							"dataValueType": 10
						},
						{
							"id": "4340b39b-efb5-6388-e0ca-546f79a142c1",
							"code": "PDS_UsrOfferType",
							"caption": "#ResourceString(PDS_UsrOfferType)#",
							"dataValueType": 10
						},
						{
							"id": "add73ab3-71af-d8da-8a28-c73a9c850706",
							"code": "PDS_UsrName",
							"caption": "#ResourceString(PDS_UsrName)#",
							"dataValueType": 28
						}
